...
namespace TestPolly.Samples
{
    ...
    /// </summary>
    public static class Demo05_WaitAndRetryNTimes_WithExponentialBackoff
    {
        public static void Execute()
        {
            ...
            var policy = Policy.Handle<Exception>().WaitAndRetry(
                retryCount: 6, // retry 6 times
                sleepDurationProvider: attempt => TimeSpan.FromSeconds(0.1 * Math.Pow(2, attempt)), // back off gradually
